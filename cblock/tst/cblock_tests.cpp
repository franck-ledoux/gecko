...
//         std::vector<gecko::cblock::Blocking::Edge> parallel_edges;
//         bl.get_all_sheet_edges(it, parallel_edges);
//         REQUIRE(parallel_edges.size() == 4);
//     }
//
//     std::vector<std::vector<gecko::cblock::Blocking::Edge>> all_edges = bl.get_all_sheet_edge_sets();
...
TEST_CASE("BlockingTestSuite - cut_sheet_param_propag", "[blocking]") {
    ...
    std::vector<gecko::cblock::Blocking::Face> surf;
    for (auto f : all_faces) {
...
//      bl.init_from_mesh(m);
//
//      std::vector<gecko::cblock::Dart3> darts;
...
//     SKIP("BlockingTestSuite test_pillow_7 not implemented");
//     gmds::cad::FACManager geom_model;
//     setUp(geom_model);
//     gecko::cblock::Blocking bl(&geom_model, true);
//     gecko::cblock::BlockingClassifier cl(&bl);
//     cl.classify();
//
//     std::vector<gecko::cblock::Blocking::Face> all_faces = bl.get_all_faces();
//
...
//     SKIP("BlockingTestSuite test_pillow_8 not implemented");
//     gmds::cad::FACManager geom_model;
//     setUp(geom_model);
//     gecko::cblock::Blocking bl(&geom_model, true);
//     gecko::cblock::BlockingClassifier cl(&bl);
//     cl.classify();
//
//     std::vector<std::vector<gecko::cblock::Blocking::Edge>> edges = bl.get_all_sheet_edge_sets();
...
//     SKIP("BlockingTestSuite test_pillow_9 not implemented");
//     gmds::cad::FACManager geom_model;
//     setUp(geom_model);
//     gecko::cblock::Blocking bl(&geom_model, true);
//     gecko::cblock::BlockingClassifier cl(&bl);
...
//     SKIP("test_pillow_11 not implemented");
//     gmds::cad::FACManager geom_model;
//     setUp(geom_model);
//     gecko::cblock::Blocking bl(&geom_model, true);
//     gecko::cblock::BlockingClassifier cl(&bl);
...
//       SKIP("test_pillow_12 not implemented");
//   gmds::cad::FACManager geom_model;
//     setUp(geom_model);
//     gecko::cblock::Blocking bl(&geom_model, true);
//     gecko::cblock::BlockingClassifier cl(&bl);
