...
namespace gecko::python {
    ...
    void register_gecko_module(py::module_ m) {
        ...
        py::class_<GeomModelFacade>(m, "GeomModel", "A geometric model, loaded from a Gmsh MSH file.")
            ...
            .def("mesh_vertices", &GeomModelFacade::mesh_vertices,
                 "(x,y,z) position of every node of the model's backing faceted mesh.")
            .def("mesh_triangles", &GeomModelFacade::mesh_triangles,
                 "Node index triples of every triangle of the model's backing mesh.")
            .def("mesh_tets", &GeomModelFacade::mesh_tets,
        ...
        py::class_<BlockingFacade>(m, "Blocking", "A structured (quad/hex) blocking of a GeomModel.")
            .def(py::init<const GeomModelFacade &, int>(), py::arg("model"), py::arg("degree") = 1,
                 py::keep_alive<1, 2>(),
            ...
            .def("nb_cells", &BlockingFacade::nb_cells, py::arg("dim"),
                 "Number of dim-cells (dim in [0,3]) in the blocking.")
            .def("is_valid_topology", &BlockingFacade::is_valid_topology,
            ...
            .def("node_position", &BlockingFacade::node_position, py::arg("node_id"),
            ...
            .def("mesh_hexes", &BlockingFacade::mesh_hexes, py::arg("subdivisions") = 1,
